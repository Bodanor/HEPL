...
int main(int argc,char *argv[])
{
 ...
 case Achat:
   ...
   resuRech=ReservationBG("VehiculesBG",UneRequete.Reference,UneRequete.Quantite);

   if(resuRech!=0)
   {
      printf("Vehicule trouver\n");
      printf("Mise à jour du fichier Facture\n");
   
     numFac= FacturationBG("FactureBG",UneRequete.NomClient,UneRequete.Date,UneRequete.Quantite,UneRequete.Reference,resuRech);
   }
 ...
 UneRequete.NumeroFacture=numFac;
